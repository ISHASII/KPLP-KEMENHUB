            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form id="ppidForm" action="{{ route('ppid.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <div id="ppidViewGambarContainer" style="margin-bottom:10px; display:none;">
                  ...
                  <div><img id="ppidViewGambar" src="" alt="Gambar" style="max-width:100%; max-height:300px; border-radius:4px;"></div>
                </div>
                <div id="ppidViewDokumenContainer" style="display:none;">
                  ...
                  <div id="ppidViewDokumenFrameContainer" style="margin-top:10px; display:none;">
                    <iframe id="ppidViewDokumenIframe" src="" style="width:100%; height:400px;" frameborder="0"></iframe>
                  </div>
                </div>
              </div>
            </div>
