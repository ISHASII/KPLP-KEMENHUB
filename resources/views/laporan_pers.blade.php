                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div id="persViewGambarContainer" style="margin-bottom:10px; display:none;">
                                ...
                                <div><img id="persViewGambar" class="clickable-preview" src="" alt="Gambar"
                                        style="max-width:100%; max-height:300px; border-radius:4px; cursor:pointer;">
                                </div>
                                <div><a id="persViewGambarDownload" href="#" download
                            ...
                            <div id="persViewDokumenContainer" style="display:none;">
                                ...
                                <div id="persViewDokumenFrameContainer" style="margin-top:10px; display:none;">
                                    <iframe id="persViewDokumenIframe" src="" style="width:100%; height:400px;"
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.view-btn').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    const imgDownload = document.getElementById('persViewGambarDownload');
                    if (d.gambarUrl) {
